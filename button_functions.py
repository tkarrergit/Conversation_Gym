...
def coaching_button(e, page:ft.Page):
        ...
        antwort = coaching_gespraech_vorbereitung() 
        klient = person_namen()
        print(klient)  
        ...
        coaching_gespraech(antwort, klient)
...
def einstellungen_button(e, page:ft.Page):
        shared.email, shared.passwort, app_starts_count = lese_email_passwort(all_functions.resource_path("assets/config.txt"))
        email_field, password_field = email_passwort_field(shared.email, shared.passwort)
